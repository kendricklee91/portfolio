from res_images import create_train_data, create_train_label
from res_images import create_valid_data, create_valid_label
from res_images import create_test_data, create_test_label

from res_images import create_fire_data, create_fire_label
from res_images import create_scab_data, create_scab_label
from res_images import create_blac_data, create_blac_label
from res_images import create_norm_data, create_norm_label
...
x = resnet50(4, img_input, include_top = True, pooling = None, input_tensor = None)
#x = resnet50(4, include_top = True, input_shape = input_shape)
...
history = model.fit(train_img, train_lbl, batch_size = 128, nb_epoch = 2, shuffle = True, validation_data=(valid_img, valid_lbl))
...
pred_norm = model.predict(norm_img) # test data에 대한 prediction 값
